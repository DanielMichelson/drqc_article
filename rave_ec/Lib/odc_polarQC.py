...
# @param list of algorithm identifier strings, each of which is used to
# lookup a quality plugin
# the chosen QC algorithms
def QC(pload):
    try:  # Override the global attribute with metadata in the payload
        aids = pload.getAttribute('how/algorithm_ids').split(",")
